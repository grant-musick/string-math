...
def initialize_equality_tests():
    zero = StringNumber("0")
    pos1 = StringNumber("1230")
    pos2 = StringNumber("456")
    neg1 = StringNumber("-111")
    neg2 = StringNumber("-333")
...
# Dynamically assign test methods
initialize_equality_tests()
...
class StringNumberTests(unittest.TestCase):
    ...
    def test_comparisons(self):
        # composite test. technically unittests should test one thing,
        # but whatever.
        zero = StringNumber("0")
        pos1 = StringNumber("1230")
        pos2 = StringNumber("456")
    ...
    def test_lt_same_numbers_pos(self):
        pass

    def test_lt_diff_numbers_pos_pos(self):
        pass

    def test_lt_diff_number_neg_neg(self):
        pass

    def test_lt_diff_numbers_pos_neg(self):
        pass

    def test_gt_same_numbers_pos(self):
        pass

    def test_gt_diff_numbers_pos_pos(self):
        pass

    def test_gt_diff_number_neg_neg(self):
        pass

    def test_gt_diff_numbers_pos_neg(self):
        pass
